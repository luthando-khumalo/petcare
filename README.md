...
petcare/
├── _css-assets/
│   └── main-style.css        # Custom site styling
├── assets/
│   ├── css/                  # Bootstrap, plugin & icon styles
│   ├── images/                # Logos & gallery images
│   └── js/                    # Bootstrap, jQuery & custom scripts
├── index.html                 # Home page
├── aboutus.html                # About page
├── courses.html                 # Courses page
├── enroll-payment.html           # Enrollment & payment page
...
```bash
git clone https://github.com/luthando-khumalo/petcare.git
cd petcare
```
